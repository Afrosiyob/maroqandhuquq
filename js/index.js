  ...
  function addDistrictHandle(data, indicatorProgress) {
    ...
    data.map((element, index) => {
      indicatorProgress.append(
        ...
        `<path d="M20 40C8.97751 40 0 31.0304 0 19.9949C0 8.95934 8.97751 0 20 0C31.0225 0 40 8.96957 40 20.0051C40 31.0407 31.0225 40 20 40ZM20 2.81258C10.5317 2.81258 2.82209 10.5242 2.82209 19.9949C2.82209 29.4656 10.5317 37.1772 20 37.1772C29.4683 37.1772 37.1779 29.4656 37.1779 19.9949C37.1779 10.5242 29.4683 2.81258 20 2.81258Z" fill="url(#paint${index + 1} _linear)"/>` +
        ...
        "</g>" +
        "<defs>" +
        `<linearGradient id="paint${index + 1}_linear" x1="24.9289" y1="0.891813" x2="13.2696" y2="46.073" gradientUnits="userSpaceOnUse">` +

$(document).ready(function() {
    ...
    const districtIndicatorTwo = [{
            title: "Соблюдение актов законодательства",
            percent: 6.8,
        },
        {
            title: "Установление правопорядка и обеспечение безопасности ",
            percent: 4.4,
        },
        {
            title: "Правосудие и исполнение судебных решений ",
            percent: 4.4,
        },
        {
            title: "Обеспечение прав и свобод граждан ",
            percent: 4.4,
        },
        {
            title: "Эффективный контроль за деятельностью органов исполнительной власти на местах ",
            percent: 4.4,
        },
        {
            title: "Эффективность противодействия коррупции ",
            percent: 4.4,
        },
        {
            title: "Прозрачность институтов власти",
            percent: 4.4,
        },
    ];
